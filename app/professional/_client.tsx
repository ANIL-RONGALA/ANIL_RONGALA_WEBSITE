        ...
        <MotionCard key={role.role} className="p-8">
          <div className="flex flex-col gap-2 md:flex-row md:items-baseline md:justify-between">
            <div>
              ...
              <p className="text-sm leading-relaxed text-muted-foreground">{role.organization}</p>
            </div>
            <p className="text-sm text-muted-foreground">
              {role.start} – {role.end}
            </p>
          </div>
          <p className="mt-3 text-sm leading-relaxed text-muted-foreground">{role.location}</p>
