  ...
  return (
    <PageTransition>
      <div className="space-y-10">
        ...
        />
        <div className="grid gap-8 rounded-3xl border border-amber-200 bg-amber-50 p-8 text-left transition-colors duration-500 backdrop-blur md:grid-cols-2 dark:border-amber-500/20 dark:bg-amber-500/10">
