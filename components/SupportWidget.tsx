    ...
    <>
      <div className="fixed bottom-5 right-5 z-50 sm:bottom-6 sm:right-6">
        <div className="group relative">
          ...
          <div className="pointer-events-none absolute bottom-full right-0 mb-3 flex translate-y-1 scale-95 items-center gap-2 rounded-xl border border-border/70 bg-background/75 px-3 py-2 text-xs text-foreground opacity-0 shadow-sm backdrop-blur transition duration-200 group-hover:translate-y-0 group-hover:scale-100 group-hover:opacity-100 group-focus-within:translate-y-0 group-focus-within:scale-100 group-focus-within:opacity-100">
          ...
          >
            ...
            <header className="relative z-10 flex items-start justify-between gap-3 border-b border-border/60 pb-4">
              ...
              <button
                ...
                className="focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring/60 inline-flex h-9 w-9 items-center justify-center rounded-full border border-border/60 text-muted-foreground transition hover:border-[hsl(var(--accent)/0.45)] hover:text-foreground hover:text-accent"
              >
                <svg
                  aria-hidden
                  viewBox="0 0 24 24"
            ...
            <div className="relative z-10 mt-4 flex flex-wrap gap-2">
              {starterPrompts.map((prompt) => (
                <button
                  key={prompt}
                  type="button"
                  className="focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring/60 rounded-full border border-border/60 bg-background/60 px-3 py-1 text-xs text-muted-foreground transition hover:border-[hsl(var(--accent)/0.45)] hover:text-foreground hover:text-accent"
            ...
            <form onSubmit={handleSubmit} className="relative z-10 mt-4 space-y-3">
              <textarea
                ...
                className="focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring/60 min-h-[72px] w-full resize-none rounded-xl border border-border/60 bg-background/70 px-4 py-3 text-sm text-foreground placeholder:text-muted-foreground outline-none transition focus:border-[hsl(var(--accent)/0.5)]"
              />
              <div className="flex flex-wrap items-center gap-2">
                <button
                  ...
                  className="focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring/60 rounded-full bg-accent px-4 py-2 text-sm font-semibold text-accent-foreground transition hover:brightness-105 hover:neon-glow disabled:cursor-not-allowed disabled:opacity-50"
                >
                  Send
                </button>
                {isStreaming && (
                  <button
                    ...
                    className="focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring/60 rounded-full border border-border/70 px-3 py-2 text-xs text-foreground transition hover:border-[hsl(var(--accent)/0.45)] hover:text-foreground hover:text-accent"
                  >
                    Stop
                  </button>
                )}
                <button
                  ...
                  className="focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring/60 rounded-full border border-border/60 px-3 py-2 text-xs text-muted-foreground transition hover:border-[hsl(var(--accent)/0.45)] hover:text-foreground hover:text-accent"
                >
                  Clear
                </button>
